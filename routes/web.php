...
Route::get('/assignment/student-submission/{assignment_id}', 'StudentAssignmentController@showStudentSubmission_teacher');//menampilkan halaman tugas oleh student anggota kursus

Route::post('assignment/grade-student', 
      'StudentAssignmentController@gradeSubmission_teacher');//

Route::get('/quiz/student-submission/{quiz_id}', 'QuizController@showStudentSubmission_teacher');//menampilkan halaman tugas oleh student anggota kursus
Route::get('/quiz/grade-student/{quiz_id}/session/{session_id}/user/{user_id}', 'QuizController@gradeSubmission_teacher');//menampilkan halaman tugas oleh student anggota kursus

Route::post('quiz/updategrade', 
      'QuizController@gradeSubmission');//
