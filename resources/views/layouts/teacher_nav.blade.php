    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <!-- <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{url('grading/assignments')}}"><i class="fa fa-circle-o"></i> Assignment submission</a></li>
            <li><a href="{{url('grading/quiz')}}"><i class="fa fa-circle-o"></i> Quiz submission</a></li>
          </ul>
        </li> -->
        <!-- <li class="treeview">
          <a href="#">
