 ...
 @include('layouts/teacher_nav')
      ...
      <div class="row">
        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
              ...
              <strong><i class="fa fa-book margin-r-5"></i> Theory Modules</strong>
              <ul> 
  ...
  <!--                   <a class="btn btn-xs btn-warning" href="../../lessons/edit/{{$lesson->id}}"><i class="fa fa-pencil"></i></a> -->
              ...
              <strong><i class="fa fa-file-text-o margin-r-5"></i> Practice Modules</strong>
              <ul>
              ...
              <strong><i class="fa fa-cubes margin-r-5"></i> Quizes</strong>
              <ul>
                <?php $i=1; ?>
                @foreach($session->quizes as $quiz)
                  <li>
                    Quiz {{$i}} 
                  <a href="{{url('quiz/student-submission/'.$quiz->id)}}"><i class="fa fa-share-square-o"></i> Show submissions</a>
              ...
              <hr>
              <strong><i class="fa fa-pencil margin-r-5"></i> Assignments</strong>
              <ul>
              @foreach($session->assignments as $assignment)
                <li>
                  {{$assignment->title}}
                  <a href="{{url('assignment/student-submission/'.$assignment->id)}}"><i class="fa fa-share-square-o"></i> Show submissions</a>
